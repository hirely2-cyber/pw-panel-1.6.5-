...
namespace App\Services\PW\Roles\Structs;

class Character174
{

    static $pack = array(
        "getRole" => 0x1F43,  //获取角色xml
        "putRole" => 0x1F42,  //保存角色xml
        'GMRoleOnline' => 0x160, //在线列表
        'forbid' => 0x168, //角色封禁
        'chatCharForbid' => 0x16A, //角色禁言
        'chatAccForbid' => 0x164, //账号禁言
        'accForbid' => 0x162,  //账号封禁
        'GetUserRoles' => 0xD49, //获取用户角色
        'RenameRole' => 0xD4C, //角色改名
        'DeleteRole' => 0xBC0, //删除角色
        'DebugAddCash' => 0x209,  //元宝充值
        'sendMail' => 0x1076, //发送邮件
        'sendChat' => 0x78, //发送广播
		'CashPasswordSet' => 0x10A7, //元宝交易密码
		'DBSetCashPassword' => 0xC1C, //元宝交易密码
		'ClearStorehousePasswd' => 0xD4A //清空仓库密码
