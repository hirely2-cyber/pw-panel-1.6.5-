...
?>
<svg xmlns="http://www.w3.org/2000/svg" width="<?php echo e($size ?? 16); ?>" height="<?php echo e($size ?? 16); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" class="<?php echo e($class ?? ''); ?>">
    <?php echo $icons[$name] ?? ''; ?>

</svg>
<?php /**PATH /var/www/html/pw-panel/resources/views/panel/_icon.blade.php ENDPATH**/ ?>